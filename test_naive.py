dataset = [
    [1, "very small", "reforestation", "good", "sunny", "very_small",'A'],
...
probability_B = B_calculate_probability(dataset)
probability_C = C_calculate_probability(dataset)
probability_D = D_calculate_probability(dataset)
probability_E = E_calculate_probability(dataset)
